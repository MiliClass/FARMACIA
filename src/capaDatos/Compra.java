...
public class Compra {
    ...
    public Compra(int idcompra, String coFecha, String coTipoDoc, String coNroDoc, String coTipoPago, String coFormaPago, String coMoneda, double coSubTotal, double coFlete, double coIgv, double coTotal, String provRuc, String uDni, String tienda) {
